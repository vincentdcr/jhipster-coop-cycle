...
class RestaurantResourceIT {
    ...
    private static final String UPDATED_NAME = "k";
    ...
    public static Restaurant createEntity(EntityManager em) {
        Restaurant restaurant = new Restaurant().name(DEFAULT_NAME).location(DEFAULT_LOCATION);
        return restaurant;
    }
    ...
    public static Restaurant createUpdatedEntity(EntityManager em) {
        Restaurant restaurant = new Restaurant().name(UPDATED_NAME).location(UPDATED_LOCATION);
        return restaurant;
    }
    ...
    void putExistingRestaurant() throws Exception {
        ...
        updatedRestaurant.name(UPDATED_NAME).location(UPDATED_LOCATION);
    ...
    void fullUpdateRestaurantWithPatch() throws Exception {
        ...
        partialUpdatedRestaurant.name(UPDATED_NAME).location(UPDATED_LOCATION);
