...
describe('Restaurant e2e test', () => {
  ...
  const restaurantSample = { name: 'd', location: 'Cambridgeshire' };
  ...
  describe('new Restaurant page', () => {
    ...
    it('should create an instance of Restaurant', () => {
      cy.get(`[data-cy="name"]`).type('b').should('have.value', 'b');

      cy.get(`[data-cy="location"]`).type('Buckinghamshire lavender tangible').should('have.value', 'Buckinghamshire lavender tangible');
