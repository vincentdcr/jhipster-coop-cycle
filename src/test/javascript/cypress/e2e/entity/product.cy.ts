...
describe('Product e2e test', () => {
  ...
  const productSample = { name: 'Balboa Sausages', price: 87107, quantity: 65101 };
  ...
  describe('new Product page', () => {
    ...
    it('should create an instance of Product', () => {
      cy.get(`[data-cy="name"]`).type('XSSX').should('have.value', 'XSSX');

      cy.get(`[data-cy="price"]`).type('57804').should('have.value', '57804');

      cy.get(`[data-cy="quantity"]`).type('55601').should('have.value', '55601');
