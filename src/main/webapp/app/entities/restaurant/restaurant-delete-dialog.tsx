...
export const RestaurantDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterCoopCycleApp.restaurant.delete.question">
        <Translate contentKey="jhipsterCoopCycleApp.restaurant.delete.question" interpolate={{ id: restaurantEntity.id }}>
