...
export const ProductDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterCoopCycleApp.product.delete.question">
        <Translate contentKey="jhipsterCoopCycleApp.product.delete.question" interpolate={{ id: productEntity.id }}>
