...
export const CooperativeDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterCoopCycleApp.cooperative.delete.question">
        <Translate contentKey="jhipsterCoopCycleApp.cooperative.delete.question" interpolate={{ id: cooperativeEntity.id }}>
