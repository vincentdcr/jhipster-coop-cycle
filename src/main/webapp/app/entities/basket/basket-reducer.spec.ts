...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './basket.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BASKET_LIST actions', async () => {
    ...
    it('dispatches FETCH_BASKET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BASKET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BASKET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BASKET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BASKET actions', async () => {
      const expectedActions = [
        {
