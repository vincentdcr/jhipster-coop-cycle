...
export const UtilisateurDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterCoopCycleApp.utilisateur.delete.question">
        <Translate contentKey="jhipsterCoopCycleApp.utilisateur.delete.question" interpolate={{ id: utilisateurEntity.id }}>
