  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterCoopCycleApp.payment.home.createOrEditLabel" data-cy="PaymentCreateUpdateHeading">
            <Translate contentKey="jhipsterCoopCycleApp.payment.home.createOrEditLabel">Create or edit a Payment</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('jhipsterCoopCycleApp.payment.paymentType')}
              ...
              >
                {paymentTypeValues.map(paymentType => (
                  <option value={paymentType} key={paymentType}>
                    {translate('jhipsterCoopCycleApp.PaymentType.' + paymentType)}
                  </option>
                ))}
              </ValidatedField>
              <ValidatedField
                label={translate('jhipsterCoopCycleApp.payment.amount')}
                id="payment-amount"
                name="amount"
                data-cy="amount"
                type="text"
              ...
              <ValidatedField
                ...
                name="order"
                data-cy="order"
                label={translate('jhipsterCoopCycleApp.payment.order')}
                type="select"
              >
                <option value="" key="0" />
                {orders
